...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cookielogy Lab — The Science of Sweet" },
      { name: "description", content: "مختبر الكوكيز الفاخر في الأردن. نكهات مبتكرة ومكونات عالية الجودة تُحضَّر يومياً. توصيل لجميع المملكة." },
      { name: "author", content: "Cookielogy Lab" },
      { name: "theme-color", content: "#3a1740" },
      { property: "og:title", content: "Cookielogy Lab — The Science of Sweet" },
      { property: "og:description", content: "Luxury artisan cookies, miniature collections and dips. Delivery across Jordan." },
